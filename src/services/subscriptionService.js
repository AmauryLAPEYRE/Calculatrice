...
export const getUserSubscription = async (firebaseUid) => {
    ...
    try {
      ...
      // Trier les abonnements par priorité (valeur plus basse = priorité plus haute)
      subscriptions.sort((a, b) => 
        (a.subscription_plans.priority || 10) - (b.subscription_plans.priority || 10)
      );
      
      // Prendre l'abonnement avec la priorité la plus haute
