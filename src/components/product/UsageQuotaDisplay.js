...
const UsageQuotaDisplay = ({ 
  ...
  // Vérifier explicitement si le plan n'est ni Essential ni Premium
const shouldShowStandardDisplay = planName !== "Essential" && planName !== "Premium";
if (shouldShowStandardDisplay) {
