...
useEffect(() => {
  ...
  // Si un paramètre de nom est présent dans l'URL, activer l'onglet 'name'
if (location.pathname.includes('recherche-filtre') && location.search.startsWith('?q=')) {
    setActiveTab('name');
    // Vous pourriez aussi lancer la recherche automatiquement ici si nécessaire
  } 
  // Si un paramètre de code-barres est présent, activer l'onglet 'barcode'
  else  {
