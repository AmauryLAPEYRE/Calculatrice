...
const ReceiptsList = () => {
  ...
  const openDetailModal = async (receipt, e) => {
    ...
    // Charger les articles du ticket s'ils n'ont pas déjà été chargés
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-end space-x-2 mt-4">
                      ...
                      {receipt.firebase_url && (
                        <button
                          onClick={(e) => openZoomViewer(receipt, e)}
                          className="flex items-center px-3 py-2 text-blue-700 bg-blue-50 border border-blue-100 rounded-md hover:bg-blue-100 transition-colors text-sm"
                        >
